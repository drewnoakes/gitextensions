...
internal sealed class CommitInfoHtmlBuilder
{
    ...
    private const string CopilotIcon = "<span style=\"display:inline-block;width:16px;text-align:center;font-size:14px\">\U0001F916</span>";
        ...
        Color? themeForeground = null)
    {
        ...
        Color headerBg = background.MakeBackgroundDarkerBy(isDark ? -0.01 : 0.02);
